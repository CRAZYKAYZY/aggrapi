...
// 	if refreshToken == "" {
// 		util.RespondWithError(w, http.StatusUnauthorized, "missing refresh token")
// 		return
// 	}
...
// 	if err != nil {
// 		util.RespondWithError(w, http.StatusInternalServerError, "failed to generate access token")
// 		return
// 	}
