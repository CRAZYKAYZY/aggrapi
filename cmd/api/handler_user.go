...
// 	if err != nil {
// 		util.RespondWithError(w, http.StatusInternalServerError, "user failed to create")
// 		return
// 	}
...
// 	if err != nil {
// 		util.RespondWithError(w, http.StatusInternalServerError, "failed to retrieve user")
// 		return
// 	}
